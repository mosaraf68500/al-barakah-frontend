                ...
                <>
                  ...
                  <div>
                    <button
                      ...
                      className="w-full py-3.5 px-4 rounded-2xl bg-white hover:bg-stone-50 border-2 border-stone-200 hover:border-stone-300 text-stone-800 font-bold text-xs sm:text-sm flex items-center justify-center gap-3 transition-all cursor-pointer shadow-xs hover:shadow-md"
                    ...
                    >
                      ...
                      <span>Sign in with Google (নিরাপদ জিমেইল লগইন)</span>
                    </button>
